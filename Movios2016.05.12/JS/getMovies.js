...
app.controller('mainControl', function($http, $scope, $compile){
  ...
  $scope.deleteMovie = function(id){
    ...
    var s  = [];
        ...
        $scope.moviesInCart = data;
        s.push(data);
        sum += parseInt(data.price);
        var strAppendClick = '<td><button ng-click="removeItemFromCart(' + data.id + ')"> hej </button></td>';
        ...
        '<td>'+ data.price + '</td>');
        angular.element(document.getElementById(compiledstrAppendClick));
